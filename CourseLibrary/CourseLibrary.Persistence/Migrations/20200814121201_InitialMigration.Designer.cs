...
namespace CourseLibrary.Persistence.EFCore.Migrations
{
    ...
    [Migration("20200814121201_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseLibrary.Domain.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("CourseLibrary.Domain.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseLibrary.Domain.Course", b =>
                {
                    b.HasOne("CourseLibrary.Domain.Author", "Author")
                        .WithMany("Courses")
